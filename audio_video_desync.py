...
def main():
    ...
    # region Wave
    # x = audio_input
    # x = ResBlock1D(filters=64, basic_block_count=1, kernel_size=21, strides=5)(x)
    # x = MaxPooling1D(pool_size=4)(x)
    # x = ResBlock1D(filters=128, basic_block_count=1, kernel_size=5, strides=4)(x)
    # x = ResBlock1D(filters=256, basic_block_count=1, kernel_size=5, strides=4)(x)
    # x = ResBlock1D(filters=256, basic_block_count=1, kernel_size=5, strides=3)(x)
    # x = ResBlock1D(filters=256, basic_block_count=1, kernel_size=3, strides=2)(x)
    # endregion

    # region Mel Spectrogram
    x = audio_input
    x = ResBlock1D(filters=128, basic_block_count=1, kernel_size=3, strides=1, use_batch_norm=False)(x)
    x = ResBlock1D(filters=128, basic_block_count=4, kernel_size=3, strides=2, use_batch_norm=False)(x)
    x = ResBlock1D(filters=64, basic_block_count=4, kernel_size=3, strides=2, use_batch_norm=False)(x)
    # endregion
    ...
    x = ResBlock3D(filters=4, basic_block_count=1, kernel_size=(1, 3, 3), strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=8, basic_block_count=1, kernel_size=(1, 3, 3), strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=16, basic_block_count=1, kernel_size=(1, 3, 3), strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=32, basic_block_count=1, kernel_size=(1, 3, 3), strides=(1, 2, 2), use_batch_norm=False)(x)
    ...
    x = ResBlock3D(filters=8, basic_block_count=1, kernel_size=3, strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=16, basic_block_count=1, kernel_size=3, strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=32, basic_block_count=1, kernel_size=3, strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=64, basic_block_count=1, kernel_size=3, strides=(1, 2, 2), use_batch_norm=False)(x)
    x = ResBlock3D(filters=128, basic_block_count=1, kernel_size=3, strides=(1, 2, 2), use_batch_norm=False)(x)
    ...
    x = ResBlock1D(filters=128, basic_block_count=1, kernel_size=3, use_batch_norm=False)(x)
    x = ResBlock1D(filters=256, basic_block_count=1, kernel_size=3, use_batch_norm=False)(x)
    x = ResBlock1D(filters=128, basic_block_count=1, kernel_size=3, use_batch_norm=False)(x)
    intermediate_fusion_output = x
    x = ResBlock1D(filters=64, basic_block_count=1, kernel_size=3, use_batch_norm=False)(x)
    x = ResBlock1D(filters=32, basic_block_count=1, kernel_size=3, use_batch_norm=False)(x)
    ...
    # x = ResBlock1DTranspose(filters=256, basic_block_count=1, kernel_size=9, strides=6)(x)
    # x = ResBlock1DTranspose(filters=128, basic_block_count=1, kernel_size=5, strides=4)(x)
    # x = ResBlock1DTranspose(filters=128, basic_block_count=1, kernel_size=5, strides=4)(x)
    # x = ResBlock1DTranspose(filters=64, basic_block_count=1, kernel_size=5, strides=4)(x)
    # x = ResBlock1DTranspose(filters=64, basic_block_count=1, kernel_size=7, strides=5)(x)
    # x = ResBlock1DTranspose(filters=audio_channels, basic_block_count=1, kernel_size=1, strides=1)(x)
    # reconstructed_audio = x
    # endregion

    # region Mel Spectrogram
    x = reconstruction_input
    x = ResBlock1DTranspose(filters=128, basic_block_count=4, kernel_size=3, strides=2, use_batch_norm=False)(x)
    x = ResBlock1DTranspose(filters=128, basic_block_count=4, kernel_size=3, strides=2, use_batch_norm=False)(x)
    ...
    x = ResBlock3DTranspose(filters=128, kernel_size=(1, 5, 5), strides=(1, 4, 4), use_batch_norm=False)(x)
    x = ResBlock3DTranspose(filters=64, kernel_size=(1, 5, 5), strides=(1, 4, 4), use_batch_norm=False)(x)
    x = ResBlock3DTranspose(filters=32, kernel_size=5, strides=(1, 4, 4), use_batch_norm=False)(x)
    x = ResBlock3DTranspose(filters=16, kernel_size=3, strides=(1, 2, 2), use_batch_norm=False)(x)
